...
class GUI(QMainWindow):
    ...
    def initLayoutFocusing(self):
        ...
        self.ui_Focusing_Focallength_Pump_SB.setDecimals(3)
        ...
        self.ui_Focusing_Focallength_Signal_SB.setDecimals(3)
        ...
        self.ui_Focusing_Focallength_Idler_SB.setDecimals(3)
        ...
        self.ui_Focusing_Beamdiameter_Pump_SB.setDecimals(3)
        ...
        self.ui_Focusing_Beamdiameter_Signal_SB.setDecimals(3)
